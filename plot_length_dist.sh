...
python plot_length_dist.py -color1 "darkgreen" -color2 "limegreen" -color3 "k" -color4 "darkgray" \
 ...
 -r1_paired_in "15_R1_adapters_removed_paired.fq.gz"  -r1_unpaired_in "15_R1_adapters_removed_unpaired.fq.gz" \
 -r2_paired_in "15_R2_adapters_removed_paired.fq.gz"  -r2_unpaired_in "15_R2_adapters_removed_unpaired.fq.gz" 
